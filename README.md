...
- **ARGUS** — see [Anand et al., 2025](https://arxiv.org/abs/2504.15562)
...
```bibtex
@inproceedings{airguard2026,
  title={AIRGuard: Contextual Authority-Risk Control for LLM Agent Runtimes},
  year={2026}
}
```
